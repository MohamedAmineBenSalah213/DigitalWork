...
export class FilterableDropdownSelectionModel  {
  ...
  private selectionStates = new Map<string, ToggleableItemState>()

  private temporarySelectionStates = new Map<string, ToggleableItemState>()
  ...
  set(id: string, state: ToggleableItemState, fireEvent = true) {
  ...
  toggle(id: string, fireEvent = true) {
  ...
  exclude(id: string, fireEvent: boolean = true) {
    let state = this.temporarySelectionStates.get(id)
  ...
  private getNonTemporary(id: string) {
